...
void loop()
{
  ...
  GyX=(Wire.read()<<8|Wire.read())+183/gsens;  // 0x43 (GYRO_XOUT_H) & 0x44 (GYRO_XOUT_L)
  GyY=(Wire.read()<<8|Wire.read())/gsens;  // 0x45 (GYRO_YOUT_H) & 0x46 (GYRO_YOUT_L)
  GyZ=((Wire.read()<<8|Wire.read())+183)/gsens;  // 0x47 (GYRO_ZOUT_H) & 0x48 (GYRO_ZOUT_L)
  ...
  GZ=GZ+GyZ*0.01;//-0002*GZL-0.002*GZLL; 0.0105 is best
  // original    
  // equation   
