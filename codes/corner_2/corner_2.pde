  ...
  for(i = 1; i < 639; i++){
   for(j = 1; j < 479; j++){
    ...
    for(i = 1; i < 636; i++){
      for(j = 1; j < 476; j++){
       index = i + j*640;
       if(brightness(edge.pixels[index]) == 255){
         if((brightness(edge.pixels[index+1]) == 255 && brightness(edge.pixels[index+2]) == 255 && brightness(edge.pixels[index+3]) == 255 &&
         brightness(edge.pixels[index+640]) == 255 && brightness(edge.pixels[index+1280]) == 255 && brightness(edge.pixels[index+1920]) == 255)){
           edge.pixels[index] = color(255,0,0);
         }
       }
      }
    }
